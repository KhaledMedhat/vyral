...
const MessageDetails: React.FC<{ message: MessageInterface, isPinComponent: boolean }> = ({ message, isPinComponent }) => {
    ...
    return (
        <div className="p-4 bg-muted rounded-md flex flex-col relative w-full" onMouseEnter={() => setMessageDetailsId(message._id)} onMouseLeave={() => setMessageDetailsId(null)}>
